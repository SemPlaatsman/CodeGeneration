...
public class DataSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        userRepository
                .save(new User(null, Role.Customer, "sarawilson", "sara123", "Sara", "Wilson", "sara.wilson@yahoo.com",
        ...
        userRepository
                .save(new User(null, Role.Customer, "janesmith", "jane123", "Jane", "Smith", "jane.smith@gmail.com",
        ...
        userRepository
                .save(new User(null, Role.Customer, "maryjo", "mary123", "Mary", "Johnson", "mary.johnson@yahoo.com",
        ...
        userRepository
                .save(new User(null, Role.Customer, "johnwilson", "john123", "John", "Wilson", "john.wilson@yahoo.com",
        ...
        // Transactions
        transactionRepository.save(new Transaction(null, LocalDateTime.of(2023, 4, 27, 18, 53, 11),
                accountRepository.findByIban("NL57INHO0552427663").orElseThrow(),
                accountRepository.findByIban("NL31INHO0095220668").orElseThrow(), new BigDecimal("100"),
        ...
        transactionRepository.save(new Transaction(null, LocalDateTime.of(2023, 4, 27, 13, 28, 1),
                accountRepository.findByIban("NL23INHO0072736988").orElseThrow(),
                accountRepository.findByIban("NL47INHO0513670038").orElseThrow(), new BigDecimal("5.50"),
                userRepository.findById(2L).orElseThrow(), "Sushibox"));
        transactionRepository.save(new Transaction(null, LocalDateTime.of(2023, 4, 27, 13, 26, 54),
                accountRepository.findByIban("NL06INHO0622818862").orElseThrow(),
                accountRepository.findByIban("NL37INHO0849482569").orElseThrow(), new BigDecimal("20000"),
        ...
        transactionRepository.save(new Transaction(null, LocalDateTime.of(2023, 4, 27, 11, 45, 23),
                accountRepository.findByIban("NL44INHO0920084766").orElseThrow(),
                accountRepository.findByIban("NL57INHO0552427663").orElseThrow(), new BigDecimal("12.50"),
                userRepository.findById(6L).orElseThrow(), "Bowlen"));
        transactionRepository.save(new Transaction(null, LocalDateTime.of(2023, 4, 26, 15, 47, 47),
                accountRepository.findByIban("NL06INHO0622818862").orElseThrow(),
                accountRepository.findByIban("NL72INHO0968171721").orElseThrow(), new BigDecimal("230000"),
        ...
        transactionRepository.save(new Transaction(null, LocalDateTime.of(2023, 4, 25, 5, 33, 53),
                accountRepository.findByIban("NL53INHO0969793709").orElseThrow(),
                accountRepository.findByIban("NL06INHO0622818862").orElseThrow(), new BigDecimal("100000"),
        ...
        transactionRepository.save(new Transaction(null, LocalDateTime.of(2023, 4, 25, 3, 26, 25),
                accountRepository.findByIban("NL76INHO0000640299").orElseThrow(),
                accountRepository.findByIban("NL06INHO0622818862").orElseThrow(), new BigDecimal("70000"),
        ...
        transactionRepository.save(new Transaction(null, LocalDateTime.of(2023, 4, 24, 23, 52, 2),
                accountRepository.findByIban("NL57INHO0552427663").orElseThrow(),
                accountRepository.findByIban("NL06INHO0622818862").orElseThrow(), new BigDecimal("50000"),
        ...
        transactionRepository.save(new Transaction(null, LocalDateTime.of(2023, 4, 24, 23, 13, 11),
                accountRepository.findByIban("NL10INHO0721943866").orElseThrow(),
                accountRepository.findByIban("NL53INHO0969793709").orElseThrow(), new BigDecimal("37.20"),
