...
public record UserUpdateRequestDTO (
        ...
        @Max(value = (Long.MAX_VALUE - 1), message = "Id is too high")
        Long id,
...
//    @PositiveOrZero(message = "All role ID's must be zero or above!")
        ...
        @Size(max = 120, message = "Email is is too long!")
        String email,
    ...
    public UserUpdateRequestDTO(Long id, List<Integer> roles, String username, String password, String firstName, String lastName, String email, String phoneNumber, LocalDate birthdate, BigDecimal dayLimit, BigDecimal transactionLimit) {
        this.id = id;
        this.roles = roles;
